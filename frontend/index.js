...
function closeLastExpandedQuestion() {
    if (lastLastExpandedQuestion && (currentExpandedQuestion.getAttribute('data-id') !== lastLastExpandedQuestion.getAttribute('data-id'))){
...
function hideQuestion(question) {
    ...
    document.querySelector(`.answer-${question.getAttribute('data-id')}`).style.display = 'none';
